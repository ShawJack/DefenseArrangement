...
public class JDateChooser extends JPanel {
    ...
    public static JDateChooser getInstance() {
        return new JDateChooser();
    }

    public static JDateChooser getInstance(Date date) {
        return new JDateChooser(date);
    }

    public static JDateChooser getInstance(String format) {
        return new JDateChooser(format);
    }

    public static JDateChooser getInstance(Date date, String format) {
        return new JDateChooser(date, format);
    }

    /**
     * Creates a new instance of JDateChooser 
     */
    private JDateChooser() {
        this(new Date());
    }

    private JDateChooser(Date date) {
        this(date, "yyyy-MM-dd");
    }

    private JDateChooser(String format) {
        this(new Date(), format);
    }

    private JDateChooser(Date date, String format) {
        initDate = date;
    ...
    public static void main(String[] args) {
        JDateChooser JDateChooser1 = JDateChooser.getInstance("yyyy-MM-dd");
        JDateChooser JDateChooser2 = JDateChooser.getInstance("yyyy-MM-dd");
        JTextField showDate1 = new JTextField("单击选择日期");
        JLabel showDate2 = new JLabel("单击选择日期");

        JDateChooser1.register(showDate1);
        JDateChooser2.register(showDate2);
